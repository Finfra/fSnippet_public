...
| id  | Folder  | prefix            | key       | suffix            | abbreviation                           |
| --- | ------- | ----------------- | --------- | ----------------- | -------------------------------------- |
| 1   | _case1  |                   | t1, test  | -                 | test-                                  |
| 2   | _case2  | -                 | t2, test  |                   | -test                                  |
| 3   | _case3  | !                 | t3, test  | !                 | !test!                                 |
| 4   | _case4  |                   | t4, test  | ==                | test==                                 |
| 5   | _case5  | ==                | t5, test  |                   | ==test                                 |
| 6   | _case6  | @@                | t6, test  | @@                | @@test@@                               |
| 7   | _case7  |                   | t7, test  | ø                 | testø                                  |
| 8   | _case8  | ø                 | t8, test  |                   | øtest                                  |
| 9   | _case9  | …                 | t9, test  | …                 | …test…                                 |
...
| 18  | _case18 | {keypad_comma}    | t18, test |                   | {keypad_comma}test                     |
| 19  | _case19 |                   | t19, test | {keypad_num_lock} | test{keypad_num_lock}                  |
| 20  | _case20 | {keypad_num_lock} | t20, test | {keypad_num_lock} | {keypad_num_lock}test{keypad_num_lock} |
| 21  | _case21 |                   | t21, test | {f1}              | test{f1}                               |
| 22  | _case22 | {f1}              | t22, test |                   | {f1}test                               |
| 23  | _case23 | {f2}              | t23, test | {f2}              | {f2}test{f2}                           |

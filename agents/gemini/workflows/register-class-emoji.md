...
```bash
# 사용법: python3 agents/gemini/skills/emoji-mapper/scripts/register_class.py [ClassName] [FilePath]
# 예시: python3 agents/gemini/skills/emoji-mapper/scripts/register_class.py "MyManager" "fSnippet/Managers/MyManager.swift"
```
> [!IMPORTANT]

...
3. **구현 vs 설계 비교 (Compare Implementation vs Design)**:
   ...
   - **Cross-Check**: 특정 설계 문서를 수정할 때 `_doc_arch/ARCHITECTURE.md`의 내용과 상충되지 않는지 반드시 확인합니다.
...
6. **이모지 적용 (Apply Emojis)**:
   ...
   - 예시: `python3 agents/gemini/skills/emoji-mapper/scripts/apply_emojis.py _doc_arch/diagram/DIAGRAM_CLASS_all.mermaid`
